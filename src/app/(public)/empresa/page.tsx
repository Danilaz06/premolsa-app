    ...
    <>
      <section className="bg-gradient-to-br from-gray-900 to-green-950 py-24 text-white text-center">
        <div className="max-w-2xl mx-auto px-6">
          <span className="inline-block text-xs font-bold uppercase tracking-widest text-green-300 bg-green-300/15 px-3 py-1 rounded-full mb-4">Quiénes somos</span>
        ...
        <div className="max-w-[1200px] mx-auto px-6 space-y-20">
          ...
          <div>
            <div className="text-center mb-12">
              <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#15803d] bg-green-50 px-3 py-1 rounded-full mb-3">Historia</span>
              <h2 className="text-3xl font-black text-gray-900">Nuestra trayectoria</h2>
            </div>
            <div className="space-y-8">
              {timeline.map((item, i) => (
                <div key={i} className="flex gap-6">
                  <div className="w-12 h-12 rounded-full bg-[#15803d] text-white flex items-center justify-center font-black text-xs flex-shrink-0">{item.year}</div>
                  <div className="pt-2">
      ...
      <section className="bg-gradient-to-br from-[#166534] to-[#15803d] py-20">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-green-100 text-lg">Contacta y te ayudamos a calcular lo que necesitas.</p>
          </div>
