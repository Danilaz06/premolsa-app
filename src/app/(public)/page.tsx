  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 via-slate-900/60 to-green-900/50" />
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24 text-white">
          ...
          <h1 className="text-5xl md:text-6xl font-black leading-[1.08] mb-6 max-w-2xl">
            ...
            <span className="text-green-300">55 años de experiencia</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            <Link href="/contacto" className="px-7 py-3.5 bg-[#15803d] text-white font-semibold rounded-lg hover:bg-[#166534] transition-colors text-base">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#15803d] bg-green-50 px-3 py-1 rounded-full mb-3">Nuestros valores</span>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#15803d] bg-green-50 px-3 py-1 rounded-full mb-3">Catálogo</span>
            ...
            {products.map(p => (
              <article key={p.title} className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:-translate-y-1 hover:shadow-xl transition-all duration-200">
                ...
                <div className="p-7">
                  ...
                  <Link href={p.href} className="inline-flex items-center border border-[#15803d] text-[#15803d] text-sm font-semibold px-4 py-2 rounded-lg hover:bg-green-50 transition-colors">
                    Ver más →
                  </Link>
                </div>
              </article>
          ...
          <div className="text-center mt-12">
            <Link href="/productos" className="px-8 py-3.5 bg-[#15803d] text-white font-semibold rounded-lg hover:bg-[#166534] transition-colors">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-12">
            <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#15803d] bg-green-50 px-3 py-1 rounded-full mb-3">Instalaciones</span>
          ...
          <div className="text-center mt-10">
            <Link href="/galeria" className="px-8 py-3.5 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-[#15803d] hover:text-[#15803d] transition-colors">
      ...
      {/* CTA */}
      <section className="bg-gradient-to-br from-[#166534] to-[#15803d] py-20">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-green-100 text-lg">Contacta con nosotros y te ayudamos a calcular lo que necesitas.</p>
          </div>
          <div className="flex flex-wrap gap-4">
            <Link href="/contacto" className="px-7 py-3.5 bg-white text-[#15803d] font-semibold rounded-lg hover:bg-gray-100 transition-colors">
              Solicitar presupuesto
            </Link>
