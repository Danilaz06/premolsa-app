    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 h-16 flex items-center px-6 gap-4 fixed top-0 left-0 right-0 z-40 shadow-sm">
        <Link href="/" className="flex items-center gap-2.5 mr-auto">
          ...
          <span className="font-black text-[#15803d] hidden sm:block">PREMOLSA</span>
        </Link>
        <nav className="flex items-center gap-1">
          <Link href="/area-cliente" className="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-[#15803d] hover:bg-green-50 rounded-lg transition-colors">
            Fichas técnicas
          </Link>
        </nav>
