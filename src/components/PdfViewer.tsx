...
export default function PdfViewer({ url, title = 'Ficha técnica', variant = 'primary', label }: Props) {
  ...
  const btnClass =
    variant === 'primary'
      ? 'w-full flex items-center justify-center gap-2 text-sm font-semibold text-white bg-[#1a56db] px-4 py-2 rounded-lg hover:bg-[#1341a8] transition-colors'
      : variant === 'outline'
      ? 'w-full flex items-center justify-center gap-2 text-sm font-medium text-[#1a56db] border border-[#1a56db] px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors'
      : 'flex items-center gap-1 text-sm font-medium text-[#1a56db] hover:underline'
        ...
        >
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="hidden sm:flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-[#1a56db] px-3 py-1.5 rounded-lg hover:bg-gray-100 transition-colors"
            ...
            <a
              href={url}
              download
              className="flex items-center gap-1.5 text-sm font-medium text-white bg-[#1a56db] px-3 py-1.5 rounded-lg hover:bg-[#1341a8] transition-colors"
              title="Descargar PDF"
            >
